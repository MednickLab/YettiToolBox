function[fillhandle,msg]=shadeAreaBetweenCurves(xpoints,upper,lower,roi,color,edge,add,transparency) 
...
if nargin<6;edge='k';end %dfault edge color is grey 
if nargin<5;color='b';end %default color is grey 
